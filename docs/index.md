...
This folder contains all project documentation related to the Spring Boot 3.x upgrade and Resilience4j migration.
...
1. **Overall status:** [FINAL_TEST_RESULTS.md](FINAL_TEST_RESULTS.md)
2. **Migration summary:** [MIGRATION_SUMMARY.md](MIGRATION_SUMMARY.md)
3. **Upgrade plan:** [Upgrade_Plan.md](Upgrade_Plan.md)
